...
copy_shared_pages(envid_t child)
{
	...
	// Recorre el espacio de direcciones del padre
	// en busca de páginas marcadas PTE_SHARE para compartirlas.
	for (i = 0; i < UTOP; i += PGSIZE) {
		// Si la pagina esta presente y marcada PTE_SHARE, compartirla
		// al address space del hijo
